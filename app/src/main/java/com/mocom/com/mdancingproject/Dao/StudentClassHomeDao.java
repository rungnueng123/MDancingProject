...
public class StudentClassHomeDao {
    ...
    public StudentClassHomeDao(String eventID, String eventStart, String eventEnd, String title, String courseID, String imgUrl, String playlistTitle, String courseStyleName, String teacher) {
